...
@Database(entities = {User.class, Bookmark.class, Category.class, Course.class, Lesson.class, Registration.class, LessonCompletion.class}, version = 3, exportSchema = false)
